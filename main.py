...
def inference():
    ...
    result = result = "load_model_time(ms):" + str(load_model_time*1000) + "\preprocess_data_time(ms):" + str(preprocess_data_time*1000) + "\model_predict_time(ms) : " + str(model_predict_time*1000) + "\\result:" + str(optim_method) 
