...
def inference():
    ...
    result = result = "load_model_time(ms):" + str(load_model_time) + "\preprocess_data_time(ms):" + str(preprocess_data_time) + "\model_predict_time(ms) : " + str(model_predict_time) + "\\result:" + str(optim_method) 
